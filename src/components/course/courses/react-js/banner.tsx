    ...
    <>
      ...
      <section className="flex items-center justify-between mt-4 mb-4">
        <ul className="flex gap-3 mt-4 mb-4 overflow-x-auto whitespace-nowrap scrollbar-hide">
          {[
            { href: "/courses/react-js", label: "Curso" },
            { href: "/courses/react-js/quizes", label: "Quizes" },
            { href: "/courses/react-js/materials", label: "Material" },
            { href: "/courses/react-js/projects", label: "Projetos" },
          ].map(({ href, label }) => (
            <li
              key={href}
